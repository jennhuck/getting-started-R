...
your working directory, and importing data and evaluating data. We will use data about Albemarle County homes.
...
Now save the document and the next time you need to review your table or graphs, you will know exactly how you made them.
...
output. I am only doing this because it is a workshop situation and I want to display the output. You
...
#2.  Create a character vector of first names consisting of 4 components: Jenn, Clay, Marieke, and David 
